    ...
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-md mx-4" hideCloseButton={true}>
        <DialogHeader className="text-center">
          ...
          <DialogTitle className="text-xl font-bold text-gray-800">Súhlas so Zberom Údajov</DialogTitle>
        </DialogHeader>

        <div className="text-sm text-gray-600 leading-relaxed space-y-4">
          <div>
            Pre zlepšenie našich služieb a pochopenie toho, ako používate našu webovú stránku, zbierame anonymné
            analytické údaje pomocou Vercel Analytics. Tieto údaje nám pomáhajú optimalizovať obsah a používateľskú
            skúsenosť.
          </div>
          ...
          <div>Všetky údaje sú anonymné a neobsahujú osobné informácie.</div>
        </div>
        ...
        <p className="text-xs text-gray-500 text-center mt-4">
          Svoje rozhodnutie môžete kedykoľvek zmeniť vymazaním cookies v prehliadači.
        </p>
      </DialogContent>
    </Dialog>
  )
