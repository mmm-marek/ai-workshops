...
const initializeTracking = async () => {
  if (!trackingEnabled) {
    try {
      ...
      console.error("Failed to initialize Vercel Analytics custom tracking:", error)
    }
  }
}
...
const BenefitItem = ({
  ...
  <div className="flex flex-col items-center text-center p-4 sm:p-6">
    ...
    <h3 className="text-lg sm:text-xl font-semibold text-gray-700 mb-2 text-responsive">{title}</h3>
    <p className="text-sm sm:text-base text-gray-600 leading-relaxed text-responsive">{children}</p>
  </div>
)
...
const faqItems = [
  {
    ...
    answer:
      "Naše workshopy sú navrhnuté pre širokú škálu profesionálov, od vedúcich pracovníkov hľadajúcich strategické poznatky o AI až po technické tímy potrebujúce praktické zručnosti a marketingové/predajné tímy, ktoré chcú využívať AI nástroje. Prispôsobujeme obsah na základe rolí a cieľov vašich účastníkov.",
  },
  {
    question: "Ponúkate školenia priamo v našich kanceláriách?",
    answer:
      "Áno, ponúkame školenia priamo vo vašej spoločnosti pre intenzívnejší zážitok, ako aj interaktívne online workshopy pre distribuované tímy.",
  },
  {
    question: "Aké predchádzajúce znalosti AI sú potrebné?",
    answer:
      "Pre mnohé z našich základných workshopov nie sú potrebné žiadne predchádzajúce znalosti AI. Prispôsobujeme zložitosť a hĺbku aktuálnemu porozumeniu vášho tímu, zabezpečujúc, že obsah je dostupný, ale zároveň náročný.",
  },
  {
    question: "Ako prispôsobujete workshopy pre naše konkrétne odvetvie?",
    answer:
      "Vykonávame dôkladnú analýzu potrieb na pochopenie vášho odvetvia, obchodných výziev a konkrétnych cieľov. Následne začleníme relevantné prípadové štúdie, datasety (ak sú poskytnuté a vhodné) a use cases do obsahu workshopu.",
  },
  {
    question: "Aké sú typické náklady na firemný workshop?",
    answer:
      "Ceny sú prispôsobené na základe rozsahu workshopu, trvania, počtu účastníkov a úrovne prispôsobenia. Kontaktujte nás pre podrobnú konzultáciu a cenový návrh prispôsobený vašim potrebám.",
  },
]
...
const workshopTypes = [
  {
    ...
    description: "Pochopte strategické dôsledky AI a identifikujte high-impact use cases pre váš biznis.",
    icon: <Brain size={20} className="mx-auto mb-2 text-white" />,
  },
  {
    title: "Praktické AI pre Technické Tímy",
    description: "Hands-on školenie kľúčových AI nástrojov a platforiem na budovanie a nasadenie AI riešení.",
  ...
  },
  {
    ...
    description: "Spolupracujte s našimi expertmi na spustení konkrétneho AI projektu vo vašej organizácii.",
...
const HeroSection = () => {
  const handleCTAClick = () => {
    ...
    if (element && scrollArea) {
      ...
      scrollArea.scrollTo({ top: elementTop, behavior: "smooth" })
    }
  }
    ...
    <div className="bg-[#2A2F5B] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-500/20 via-[#2A2F5B] to-[#2A2F5B] text-white py-16 sm:py-20 md:py-32 min-h-screen flex items-center overflow-hidden w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center pt-16 sm:pt-20 w-full">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold mb-4 sm:mb-6 leading-tight font-montserrat text-responsive">
          Odomknite Inovácie & Efektivitu: <br className="hidden sm:block" />
        ...
        <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-gray-100 mb-6 sm:mb-8 md:mb-10 max-w-4xl mx-auto px-2 text-responsive">
          Transformujte vaše obchodné operácie, zvýšte produktivitu a získajte konkurenčnú výhodu s našimi
          prispôsobenými AI školeniami navrhnutými pre firemné tímy.
        </p>
        <button
        ...
        <div className="mt-8 sm:mt-12 text-xs sm:text-sm text-gray-200 px-4 text-responsive">
          ...
          <span className="font-semibold mx-1 sm:mx-2">Innovate Corp</span> |
          <span className="font-semibold mx-1 sm:mx-2">Future Solutions</span> |
          <span className="font-semibold mx-1 sm:mx-2">Global Enterprises</span>
        </div>
      </div>
    </div>
  )
    ...
    <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
      ...
      <div className="text-gray-700 order-1 lg:order-2">
        ...
        <p className="mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base text-responsive">
          V dnešnom rýchlo sa meniacom technologickom prostredí, neprispôsobenie sa AI nie je len zmeškaná príležitosť –
          je to riziko pre vašu konkurenčnú výhodu. Mnohé spoločnosti čelia podobným výzvam:
        </p>
        <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
          <li className="flex items-start">
            <CheckCircle className="text-purple-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={16} />
            <span className="text-sm sm:text-base text-responsive">
              Sú vaše tímy neisté, ako efektívne využívať AI nástroje pre hmatateľné obchodné výsledky?
            </span>
          </li>
          <li className="flex items-start">
            <CheckCircle className="text-purple-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={16} />
            <span className="text-sm sm:text-base text-responsive">
              Obávate sa zaostávania za konkurenciou, ktorá už implementuje AI stratégie?
            </span>
          </li>
          <li className="flex items-start">
            <CheckCircle className="text-purple-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={16} />
            <span className="text-sm sm:text-base text-responsive">
              Plytvanie zdrojmi na AI iniciatívy, ktoré neprinášajú jasné ROI alebo sa nezhodujú s obchodnými cieľmi?
            </span>
          </li>
          <li className="flex items-start">
            <CheckCircle className="text-purple-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={16} />
            <span className="text-sm sm:text-base text-responsive">
              Bojujete s preklenutím medzery medzi AI potenciálom a praktickou implementáciou?
            </span>
          </li>
        </ul>
        <p className="leading-relaxed font-medium text-sm sm:text-base text-responsive">
          Dobré správy? Tieto výzvy sú riešiteľné so správnym školením a strategickým prístupom.
        </p>
      </div>
    </div>
  </SectionWrapper>
...
const SolutionSection = () => (
  <div className="w-full bg-gray-50">
    <SectionWrapper id="solution" className="py-12 sm:py-16 md:py-24">
      <SectionTitle>Naše AI Workshopy: Praktické, Výsledkovo-Orientované Školenie</SectionTitle>
      <p className="text-center text-gray-600 max-w-4xl mx-auto mb-8 sm:mb-12 leading-relaxed text-sm sm:text-base px-4 text-responsive">
        Naše hands-on AI workshopy sú navrhnuté tak, aby vybavili vašich zamestnancov – od vedúcich pracovníkov až po
        technické tímy – znalosťami a zručnosťami na implementáciu AI riešení, ktoré poháňajú hmatateľný obchodný rast.
        Zameriavame sa na praktickú aplikáciu, nie len teóriu.
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
        <BenefitItem icon={<Zap size={24} />} title="Konkurenčná Výhoda">
          Zostaňte vpred využívaním najmodernejšej AI pre významnú konkurenčnú výhodu vo vašom odvetví.
        </BenefitItem>
        <BenefitItem icon={<CheckCircle size={24} />} title="Praktické Zručnosti">
          Zabezpečte rozvoj praktických zručností, umožňujúc vášmu tímu okamžite aplikovať AI na reálne úlohy a
          projekty.
        </BenefitItem>
        <BenefitItem icon={<Brain size={24} />} title="Prispôsobený Obsah">
          Získajte školenie priamo relevantné pre vaše odvetvie a konkrétne obchodné výzvy, maximalizúc ROI.
        </BenefitItem>
        <BenefitItem icon={<Users size={24} />} title="Expertní Inštruktori">
          Učte sa od skúsených AI praktikov, ktorí prekladajú komplexné koncepty do realizovateľných obchodných
          stratégií.
        </BenefitItem>
      </div>
      <div className="mt-8 sm:mt-12 text-center px-4">
        <p className="text-lg sm:text-xl text-gray-700 font-semibold max-w-4xl mx-auto text-responsive">
          Na rozdiel od generických online kurzov, naše workshopy sú interaktívne, plne prispôsobené vašim obchodným
          potrebám a zameriavajú sa na praktickú implementáciu zabezpečujúcu okamžitú hodnotu.
        </p>
      </div>
    </SectionWrapper>
  </div>
...
const HowItWorksSection = () => (
  <SectionWrapper className="py-12 sm:py-16 md:py-24 bg-white">
    ...
    <p className="text-center text-gray-600 max-w-4xl mx-auto mb-8 sm:mb-12 leading-relaxed text-sm sm:text-base px-4 text-responsive">
      Ponúkame škálu AI workshopov prispôsobených rôznym potrebám vo vašej organizácii. Naším cieľom je poskytnúť jasnú
      cestu k AI enablementu, od stratégie po realizáciu.
    </p>
    ...
    <div className="mt-12 sm:mt-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-center">
        {[
          { stage: "1. Konzultácia", detail: "Úvodná diskusia a analýza potrieb na pochopenie vašich cieľov." },
          { stage: "2. Vlastný Dizajn", detail: "Prispôsobené kurikulum workshopu a materiály pre váš tím." },
          { stage: "3. Interaktívne Dodanie", detail: "Pútavé workshopy dodané online alebo na mieste expertmi." },
          { stage: "4. Podpora & Follow-up", detail: "Post-workshop zdroje, Q&A a voliteľná pokračujúca podpora." },
        ].map((item, index) => (
          <div
            key={index}
          ...
          >
            <div className="text-purple-500 font-bold text-2xl sm:text-3xl lg:text-4xl mb-2">{index + 1}</div>
            <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-700 mb-1 text-responsive">
              {item.stage}
            </h4>
            <p className="text-xs sm:text-sm text-gray-600 text-responsive">{item.detail}</p>
          </div>
        ))}
      </div>
    </div>
...
// Pricing Section
const PricingSection = ({ onPackageSelect }: { onPackageSelect: (packageId: string) => void }) => {
  const handlePackageSelect = (packageId: string) => {
    const selectedPackage = workshopPackages.find((pkg) => pkg.id === packageId)
    ...
    <div className="w-full bg-gradient-to-br from-gray-50 to-blue-50">
      <SectionWrapper id="pricing" className="py-12 sm:py-16 md:py-24">
        <SectionTitle>
          ...
          {"pracovných miest."}
          <div className="mt-2 sm:mt-4">{"Váš tím by nemal byť jedným z nich."}</div>
        </SectionTitle>
        <p className="text-center text-gray-600 max-w-4xl mx-auto mb-8 sm:mb-12 leading-relaxed text-sm sm:text-base px-4 text-responsive">
          Ponúkame tri úrovne workshopov prispôsobené rôznym potrebám a rozpočtom. Každý balík poskytuje praktické
          znalosti a nástroje na transformáciu vášho biznisu pomocou AI.
        </p>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto mt-2">
          {/* AI Explorer */}
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg border border-gray-200 p-4 sm:p-6 lg:p-8 relative">
            <div className="text-center mb-4 sm:mb-6">
              ...
              <div className="mb-3 sm:mb-4">
                <span className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800">€347</span>
              </div>
            ...
            <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
              <li className="flex items-start">
                <CheckCircle className="text-blue-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
              ...
              <li className="flex items-start">
                <CheckCircle className="text-blue-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
                <span className="text-gray-700 text-xs sm:text-sm text-responsive">Live Skupinové Q&A Sekcie</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="text-blue-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
                <span className="text-gray-700 text-xs sm:text-sm text-responsive">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border-2 border-purple-300 p-4 sm:p-6 lg:p-8 relative transform lg:scale-105">
            ...
            <div className="text-center mb-4 sm:mb-6 mt-3 sm:mt-4">
              ...
              <div className="mb-3 sm:mb-4">
                <span className="text-2xl sm:text-3xl lg:text-4xl font-bold text-purple-600">€597</span>
              </div>
              <p className="text-gray-600 text-xs sm:text-sm text-responsive">Najlepší pomer ceny a hodnoty</p>
            </div>

            <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
              <li className="flex items-start">
                <CheckCircle className="text-purple-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
              ...
              <li className="flex items-start">
                <CheckCircle className="text-purple-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
                <span className="text-gray-700 text-xs sm:text-sm text-responsive">Rozšírený Digitálny Toolkit</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="text-purple-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
                <span className="text-gray-700 text-xs sm:text-sm text-responsive">
              ...
              <li className="flex items-start">
                <CheckCircle className="text-purple-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
                <span className="text-gray-700 text-xs sm:text-sm text-responsive">Certifikát o Absolvovaní</span>
              </li>
              <li className="flex items-start">
                <Star className="text-yellow-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
                <span className="text-gray-700 text-xs sm:text-sm font-medium text-responsive">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg border border-gray-200 p-4 sm:p-6 lg:p-8 relative">
            <div className="text-center mb-4 sm:mb-6">
              ...
              <div className="mb-3 sm:mb-4">
                <span className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800">€1197</span>
              </div>
              <p className="text-gray-600 text-xs sm:text-sm text-responsive">Komplexný a personalizovaný prístup</p>
            </div>
            ...
            <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
              ...
              <li className="flex items-start">
                <CheckCircle className="text-blue-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
                <span className="text-gray-700 text-xs sm:text-sm text-responsive">
                  1-na-1 Personalizovaná AI Stratégia Sesia (60 min)
                </span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="text-blue-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
                <span className="text-gray-700 text-xs sm:text-sm text-responsive">Premium Knižnica Zdrojov</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="text-blue-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
                <span className="text-gray-700 text-xs sm:text-sm text-responsive">
              ...
              <li className="flex items-start">
                <Star className="text-yellow-500 mr-2 sm:mr-3 mt-1 flex-shrink-0" size={14} />
                <span className="text-gray-700 text-xs sm:text-sm font-medium text-responsive">
                  EXKLUZÍVNY BONUS: Malá Mastermind Skupina (2 hodiny)
                </span>
              </li>
            </ul>
            ...
            <div className="lg:col-span-1 text-center">
              ...
              <div className="flex justify-center space-x-3 sm:space-x-4">
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault()
                    track("Social Link Clicked", { platform: "LinkedIn", section: "lecturer" })
                  }}
                >
                  <Linkedin size={20} />
                </a>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault()
                    track("Social Link Clicked", { platform: "Twitter", section: "lecturer" })
                  }}
                >
                  <Twitter size={20} />
                </a>
            ...
            <div className="lg:col-span-2">
              <div className="mb-4 sm:mb-6">
                ...
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base text-responsive">
                  Viac ako 15 rokov skúseností v AI a strojovom učení. PhD. v Computer Science, publikoval 50+
                  výskumných prác. Bývalý Head of AI Strategy v TechCorp a Senior Research Scientist v Google AI.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
                  {[
                    ...
                    <div key={index} className="flex items-center">
                      <CheckCircle className="text-purple-500 mr-2 flex-shrink-0" size={14} />
                      <span className="text-gray-700 text-xs sm:text-sm text-responsive">{skill}</span>
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-purple-100">
                <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-800 mb-2 flex items-center text-responsive">
                  <Star className="text-purple-500 mr-2" size={16} />
                  Filozofia Vyučovania
                </h4>
                <p className="text-gray-600 text-xs sm:text-sm leading-relaxed italic text-responsive">
                  "Zameriavam sa na praktické AI riešenia. Moje workshopy preklenujú medzeru medzi výskumom a obchodnou
                  aplikáciou."
                </p>
              </div>
            </div>
...
const FAQItem = ({ q, a }: { q: string; a: string }) => {
  ...
  return (
    <div className="border-b border-purple-200 py-4 sm:py-6">
      ...
      >
        <span className="text-sm sm:text-base lg:text-lg font-medium pr-4 text-responsive">{q}</span>
        {isOpen ? (
          <ChevronUp size={20} className="text-purple-500 flex-shrink-0" />
        ) : (
          <ChevronDown size={20} className="flex-shrink-0" />
        )}
      </button>
      {isOpen && <p className="mt-2 sm:mt-3 text-gray-600 leading-relaxed text-sm sm:text-base text-responsive">{a}</p>}
    </div>
  )
}
...
const CTASection = ({ selectedPackage }: { selectedPackage: string }) => {
  ...
  useEffect(() => {
    if (selectedPackage) {
      const packageName = workshopPackages.find((pkg) => pkg.id === selectedPackage)?.name || selectedPackage
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setIsSubmitted(true)
      setFormData({ name: "", company: "", email: "", message: "", subject: "" })
      ...
      toast({
        title: "Úspech!",
        description: "Vaša žiadosť bola odoslaná. Čoskoro sa vám ozveme.",
      })
    } catch (error) {
      ...
      toast({
        ...
        description: "Skúste to prosím neskôr alebo nás kontaktujte priamo.",
        variant: "destructive",
      })
    } finally {
    ...
    <div className="w-full bg-[#2A2F5B] bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-indigo-500/20 via-[#2A2F5B] to-[#2A2F5B] text-white">
      <SectionWrapper id="cta" className="py-12 sm:py-16 md:py-24">
        ...
        <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-blue-100 mb-6 sm:mb-8 md:mb-10 max-w-3xl mx-auto px-4 text-responsive text-center">
          Poďme prediskutovať, ako naše prispôsobené AI workshopy môžu pomôcť vašej spoločnosti zvýšiť efektivitu,
          podporiť inovácie a dosiahnuť významnú konkurenčnú výhodu.
        </p>
        ...
        {isSubmitted ? (
          <div className="bg-white text-green-600 p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-xl max-w-md mx-auto text-center border border-purple-100">
            <CheckCircle size={40} className="mx-auto mb-3 sm:mb-4 text-green-500" />
            <h3 className="text-xl sm:text-2xl font-semibold mb-2 text-responsive">Ďakujeme!</h3>
          ...
          <div className="bg-white text-gray-800 p-4 sm:p-6 md:p-8 lg:p-10 rounded-2xl sm:rounded-3xl shadow-2xl max-w-2xl mx-auto border border-purple-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div>
                <label htmlFor="subject" className="block text-xs sm:text-sm font-medium text-gray-700 text-left mb-1">
                  Predmet
                </label>
                <Select value={formData.subject} onValueChange={handleSubjectChange}>
                  ...
                  <SelectContent>
                    <SelectItem value="AI Explorer" className="text-xs sm:text-sm">
                      AI Explorer Workshop
                    </SelectItem>
                    <SelectItem value="AI Innovator" className="text-xs sm:text-sm">
                      AI Innovator Workshop
                    </SelectItem>
                    <SelectItem value="AI Visionary" className="text-xs sm:text-sm">
                      AI Visionary Workshop
                    </SelectItem>
                    <SelectItem value="Konzultácia" className="text-xs sm:text-sm">
                      Bezplatná Konzultácia
                    </SelectItem>
                    <SelectItem value="Iné" className="text-xs sm:text-sm">
                      Iné
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div>
                <label htmlFor="name" className="block text-xs sm:text-sm font-medium text-gray-700 text-left mb-1">
                  Celé Meno
                </label>
                <Input
                  type="text"
              ...
              <div>
                <label htmlFor="company" className="block text-xs sm:text-sm font-medium text-gray-700 text-left mb-1">
                  Názov Spoločnosti
                </label>
                <Input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-xs sm:text-sm font-medium text-gray-700 text-left mb-1">
                  Pracovný Email
                </label>
                <Input
                  type="email"
              ...
              <div>
                <label htmlFor="message" className="block text-xs sm:text-sm font-medium text-gray-700 text-left mb-1">
              ...
              <div className="flex items-start space-x-3">
                ...
                <label htmlFor="terms" className="text-xs sm:text-sm text-gray-700 leading-relaxed cursor-pointer">
                  ...
                  <Link
                    ...
                    onClick={() => track("Terms Link Clicked", { section: "contact_form" })}
                  >
                    Podmienkami služby
                  </Link>{" "}
                  a{" "}
                  <Link
                    ...
                    rel="noopener noreferrer"
                    className="text-blue-600 hover:text-blue-800 underline"
                    onClick={() => track("Privacy Policy Link Clicked", { section: "contact_form" })}
                  >
              ...
              >
                {isSubmitting ? "Odosielam..." : "Požiadajte o Bezplatnú Konzultáciu"}
              </Button>
            </form>
            <p className="text-xs text-gray-500 mt-4 sm:mt-6 text-center px-2 text-responsive">
              Vaša úvodná konzult ácia je bezplatná, bez záväzkov. Rešpektujeme vaše súkromie a nikdy nebudeme zdieľať
              vaše informácie.
            </p>
          </div>
        )}
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
        <div>
          ...
          <p className="text-xs sm:text-sm leading-relaxed text-responsive">
            Posilňujeme podniky prostredníctvom transformačného AI vzdelávania a praktického rozvoja zručností.
          </p>
        </div>
        <div>
          <h5 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3 text-responsive">Rýchle Odkazy</h5>
          <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
            <li>
              <a
                ...
                onClick={(e) => {
                  e.preventDefault()
                  track("Footer Link Clicked", { link: "Požiadajte o Konzultáciu" })
                  const element = document.getElementById("cta")
                  const scrollArea = document.querySelector("[data-radix-scroll-area-viewport]")
                  if (element && scrollArea) {
                    const elementTop = element.offsetTop - 80
            ...
            <li>
              <a
                ...
                onClick={(e) => {
                  e.preventDefault()
                  track("Footer Link Clicked", { link: "Prečo AI Workshopy?" })
            ...
            <li>
              <a
                ...
                onClick={(e) => {
                  e.preventDefault()
                  track("Footer Link Clicked", { link: "Náš Prístup" })
            ...
            <li>
              <a
                ...
                onClick={(e) => {
                  e.preventDefault()
                  track("Footer Link Clicked", { link: "FAQ" })
        ...
        <div>
          ...
          <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
            <li className="flex items-center">
              ...
              <span className="text-responsive">info@aiworkshopexperts.com</span>
            </li>
            <li className="flex items-center">
              <Phone size={14} className="mr-2 flex-shrink-0" />
              <span className="text-responsive">+421 123 456 789</span>
            </li>
            <li className="flex items-center">
              <Building size={14} className="mr-2 flex-shrink-0" />
              <span className="text-responsive">Bratislava, Slovensko</span>
            </li>
          </ul>
          <div className="flex space-x-3 sm:space-x-4 mt-3 sm:mt-4">
            <a
              ...
              onClick={(e) => {
                e.preventDefault()
                track("Social Link Clicked", { platform: "LinkedIn", section: "footer" })
              }}
            >
              <Linkedin size={18} />
            </a>
            <a
              ...
              onClick={(e) => {
                e.preventDefault()
                track("Social Link Clicked", { platform: "Twitter", section: "footer" })
              }}
            >
              <Twitter size={18} />
            </a>
      ...
      <div className="border-t border-gray-700 pt-6 sm:pt-8 text-center text-xs sm:text-sm">
        <p className="text-responsive">
          &copy; {new Date().getFullYear()} AI Workshop Experti. Všetky práva vyhradené.
        </p>
        <p className="mt-1 text-responsive">
          <a
            href="/privacy"
            className="hover:text-purple-400 transition-colors"
            onClick={() => track("Footer Link Clicked", { link: "Zásady Ochrany Súkromia" })}
          >
          ...
          <a
            href="/terms"
            className="hover:text-purple-400 transition-colors"
            onClick={() => track("Footer Link Clicked", { link: "Podmienky Služby" })}
          >
            Podmienky Služby
          </a>
        </p>
...
export default function Home() {
  ...
  return (
    <ScrollArea className="h-screen mobile-vh-fix">
